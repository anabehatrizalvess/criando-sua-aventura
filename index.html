...
<body>
    <main>
        ...
        <div class="passo" id="passo-1">
            <p>Você começa sua jornada no Brasil, subindo o Pico de uma montanha ao amanhecer para encontrar a primeira pista.</p>
            <button class="btn-proximo" data-proximo="3">Procurar a pista no topo da montanha</button>
            <button class="btn-proximo" data-proximo="4">Desistir e voltar para casa</button>
        </div>
        <div class="passo" id="passo-2">
            <p>Em Paraty, você visita a histórica cidade. Na carta, uma das pistas indica que para localizar a entrada para a cidade perdida você deve procurar a próxima pista em um dos pontos turísticos da cidade. Por qual você começa?</p>
            <button class="btn-proximo" data-proximo="5">Investigar os pontos turisticos </button>
            <button class="btn-proximo" data-proximo="6">Explorar as praias próximas</button>
        </div>
        <div class="passo" id="passo-3">
            <p>em uma ilha de paraty, você encontra uma antiga inscrição apontando que a próxima pista está
                localizada no na praia de Ipanema.</p>
            <button class="btn-proximo" data-proximo="7">Seguir para Ipanema</button>
        </div>
        ...
        <div class="passo" id="passo-5">
            <p>Em uma ilhas de Paraty, você descobre um mapa antigo escondido atrás de uma pedra, apontando que a próxima
                pista está em Ipanema.</p>
            <button class="btn-proximo" data-proximo="7">Viajar para Ipanema</button>
        </div>

        <div class="passo" id="passo-6">
            <p>Explorando as praias, você encontra uma caverna escondida, mas ela leva a um beco sem saída.</p>
            <button class="btn-proximo" data-proximo="8">Voltar e explorar as praias </button>
        </div>

        <div class="passo" id="passo-7">
            <p>em Ipanema, a busca pela cidade perdida se intensifica. Você se depara com um rio bifurcado.</p>
        ...
        <div class="passo" id="passo-8">
            <p>De volta às ilhas, você finalmente encontra o mapa antigo. Agora, para o Ipanema!</p>
            <button class="btn-proximo" data-proximo="7">Seguir para o Ipanema</button>
        </div>
